...
<form class="pkp_form" id="createReviewerForm" method="post" action="{url op="createReviewer"}" >
	...
	{fbvFormSection title="common.name"}
		{fbvElement type="text" label="user.firstName" multilingual="true" id="firstName" value=$firstName required="true" inline=true size=$fbvStyles.size.SMALL}
		{fbvElement type="text" label="user.middleName" multilingual="true" id="middleName" value=$middleName inline=true size=$fbvStyles.size.SMALL}
		{fbvElement type="text" label="user.lastName" multilingual="true" id="lastName" value=$lastName required="true" inline=true size=$fbvStyles.size.MEDIUM}
	{/fbvFormSection}
